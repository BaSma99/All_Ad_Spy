...
$(function () {
  ...
  var preloader = $("#preloader"); // Check If Exist
  ...
  var arrow = $("#top"); // Get Current Window

  var win = $(window); // Smooth Scrolling On Go To Top Arrow Click In 500ms
  ...
  var responsiveNavIcon = document.querySelector(".responsive-nav-icon button i"); // Add Event Listener To All Document To Close Nav
